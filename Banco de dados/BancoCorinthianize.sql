...
insert into Titulos (campeonato, qtd) values
	('Paulistão', 30),
    ('Brasileirão', 7),
    ('Copa do Brasil', 3),
    ('Libertadores', 1),
...
select * from Usuario where email = 'kawan@gmail.com';
...
select count(resultado) as total,  avg(resultado) as media from ResultadoQuiz;
